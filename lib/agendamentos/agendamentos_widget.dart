...
/// crie uma pagina com os agendamentos do dia
              ...
              desktop: false,
                ...
                ? AppBar(
                    ...
                    leading: FlutterFlowIconButton(
                      ...
                      onPressed: () async {
                        logFirebaseEvent(
                            'AGENDAMENTOS_arrow_back_rounded_ICN_ON_T');
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Opacity(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        '7xk94r1m' /* Gerencie os treinos dos seus a... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                      ...
                      Padding(
                        ...
                        child: AuthUserStreamWidget(
                          builder: (context) => Builder(
                            builder: (context) {
                              final agendamentos =
                                  (currentUserDocument?.agendamento?.toList() ??
                                          [])
                                      .toList();
                                ...
                                itemBuilder: (context, agendamentosIndex) {
                                  ...
                                  return Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'AGENDAMENTOS_Container_qjki4679_ON_TAP');
                                        logFirebaseEvent(
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  Opacity(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'bqg2802u' /* Gerencie os treinos dos seus a... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                ...
                                itemBuilder: (context, agendamentosIndex) {
                                  ...
                                  return Padding(
                                    ...
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        logFirebaseEvent(
                                            'AGENDAMENTOS_Container_bfpdanho_ON_TAP');
                                        logFirebaseEvent(
                                            'Container_navigate_to');
