...
/// pagina de administrador contendo funcoes e todos os usuarios
                ...
                ? AppBar(
                    ...
                    title: Text(
                      FFLocalizations.of(context).getText(
                        '7ipl5mf8' /* Dashboard do Administrador */,
                      ),
                      style:
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'ADMIN_Container_50ym50lg_ON_TAP');
                                              logFirebaseEvent(
                                          ...
                                          Padding(
                                            ...
                                            child: InkWell(
                                              ...
                                              onTap: () async {
                                                logFirebaseEvent(
                                                    'ADMIN_Container_e8xip1eq_ON_TAP');
                                                logFirebaseEvent(
                                                    'Container_navigate_to');

                                                context.pushNamed(
                                                    NotificacaoAdminWidget
                                                        .routeName);
                                              },
                                              child: Container(
                                                width: 160.0,
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          InkWell(
                                            ...
                                            onTap: () async {
                                              logFirebaseEvent(
                                                  'ADMIN_Container_z3drwa71_ON_TAP');
                                              logFirebaseEvent(
                                                  'Container_navigate_to');

                                              context.pushNamed(
                                                EditarTreinosModoAdminWidget
                                                    .routeName,
                                                queryParameters: {
                                                  'users': serializeParam(
                                                    widget!.users,
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'ADMIN_PAGE_PAGE_Icon_ai3gtovg_ON_TAP');
                                            logFirebaseEvent(
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            logFirebaseEvent(
                                                'ADMIN_PAGE_PAGE_Text_l68uwc06_ON_TAP');
                                            logFirebaseEvent(
                                                'Text_navigate_to');

                                            context.pushNamed(
                                                TodosOsUsuariosWidget
                                                    .routeName);
                                          },
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                          ...
                          wrapWithModel(
                            model: _model.pagamentosNoAppModel,
                            updateCallback: () => safeSetState(() {}),
                            child: PagamentosNoAppWidget(),
                          ),
