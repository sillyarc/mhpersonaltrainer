...
import 'card_acoes_copy2_copy_copy_model.dart';
export 'card_acoes_copy2_copy_copy_model.dart';

class CardAcoesCopy2CopyCopyWidget extends StatefulWidget {
  const CardAcoesCopy2CopyCopyWidget({
    super.key,
  ...
  @override
  State<CardAcoesCopy2CopyCopyWidget> createState() =>
      _CardAcoesCopy2CopyCopyWidgetState();
}

class _CardAcoesCopy2CopyCopyWidgetState
    extends State<CardAcoesCopy2CopyCopyWidget> {
  late CardAcoesCopy2CopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CardAcoesCopy2CopyCopyModel());
              ...
              children: [
                Padding(
                  ...
                  child: InkWell(
                    ...
                    onTap: () async {
                      logFirebaseEvent(
                          'CARD_ACOES_COPY2_COPY_COPY_Card_11_ON_TA');
