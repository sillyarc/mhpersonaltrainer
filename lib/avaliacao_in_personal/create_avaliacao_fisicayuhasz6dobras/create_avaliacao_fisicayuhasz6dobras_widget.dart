...
import 'create_avaliacao_fisicayuhasz6dobras_model.dart';
export 'create_avaliacao_fisicayuhasz6dobras_model.dart';

class CreateAvaliacaoFisicayuhasz6dobrasWidget extends StatefulWidget {
  const CreateAvaliacaoFisicayuhasz6dobrasWidget({
    super.key,
    required this.users,
  });
  ...
  static String routeName = 'createAvaliacaoFisicayuhasz6dobras';
  static String routePath = 'createAvaliacaoFisicayuhasz6dobras';

  @override
  State<CreateAvaliacaoFisicayuhasz6dobrasWidget> createState() =>
      _CreateAvaliacaoFisicayuhasz6dobrasWidgetState();
}

class _CreateAvaliacaoFisicayuhasz6dobrasWidgetState
    extends State<CreateAvaliacaoFisicayuhasz6dobrasWidget> {
  late CreateAvaliacaoFisicayuhasz6dobrasModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => CreateAvaliacaoFisicayuhasz6dobrasModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'createAvaliacaoFisicayuhasz6dobras'});
    ...
    _model.fullNameMask20 = MaskTextInputFormatter(mask: '##.#');
    _model.fullNameTextController21 ??= TextEditingController();
    _model.fullNameFocusNode21 ??= FocusNode();
    _model.fullNameFocusNode21!.addListener(() => safeSetState(() {}));
    _model.fullNameMask21 = MaskTextInputFormatter(mask: '##.#');
    _model.fullNameTextController22 ??= TextEditingController();
    _model.fullNameFocusNode22 ??= FocusNode();
    _model.fullNameFocusNode22!.addListener(() => safeSetState(() {}));
    _model.fullNameMask22 = MaskTextInputFormatter(mask: '##.#');
    _model.fullNameTextController23 ??= TextEditingController();
    _model.fullNameFocusNode23 ??= FocusNode();
    _model.fullNameFocusNode23!.addListener(() => safeSetState(() {}));
    _model.fullNameMask23 = MaskTextInputFormatter(mask: '##.#');
    _model.fullNameTextController24 ??= TextEditingController();
    _model.fullNameFocusNode24 ??= FocusNode();
    _model.fullNameFocusNode24!.addListener(() => safeSetState(() {}));
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final createAvaliacaoFisicayuhasz6dobrasUsersRecord = snapshot.data!;

        return Title(
            title: 'createAvaliacaoFisicayuhasz6dobras',
              ...
              child: Scaffold(
                        ...
                        child: AppBar(
                          ...
                          title: StreamBuilder<List<AvaliacoesFisicasRecord>>(
                            stream: queryAvaliacoesFisicasRecord(
                              parent:
                                  createAvaliacaoFisicayuhasz6dobrasUsersRecord
                                      .reference,
                              singleRecord: true,
                            ),
                            builder: (context, snapshot) {
                              ...
                              return Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'fhvmv3vr' /* Avalie as métricas deste aluno... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                          ...
                          actions: [
                            Padding(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CREATE_AVALIACAO_FISICAYUHASZ6DOBRAS_clo');
                ...
                body: SafeArea(
                  ...
                  child: StreamBuilder<List<AvaliacoesFisicasRecord>>(
                    stream: queryAvaliacoesFisicasRecord(
                      parent: createAvaliacaoFisicayuhasz6dobrasUsersRecord
                          .reference,
                      singleRecord: true,
                    ),
                    builder: (context, snapshot) {
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'g5pn6c2d' /* Braço Esquerdo: Exemplo: 26.5 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'olqqyj7c' /* Braço Direito: Exemplo: 26.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'blarkqo1' /* Abdominal: Exemplo: 80.5 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'zu74pibv' /* Quadril: Exemplo: 100.5 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'g9jnov1v' /* Coxa Esquerda: Exemplo: 50.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'v1604pn9' /* Coxa Direita: Exemplo: 70.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'goaaa69v' /* Perna Esquerda: Exemplo: 30.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'j9lnqv61' /* Perna Direita: Exemplo: 30.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'myre6yf1' /* Tricipital: Exemplo: 19.5 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'nerraoec' /* Subescapular: Exemplo: 17.5 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    '3mqk5g9l' /* Supra-Ilíaca: Exemplo: 15.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'bt5d3xqp' /* Peitoral: Exemplo: 20.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'f88w5d2o' /* Abdominal: Exemplo: 20.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                                ...
                                                validator: _model
                                                    ...
                                                    .asValidator(context),
                                                inputFormatters: [
                                                  _model.fullNameMask20
                                                ],
                                              ),
                                              TextFormField(
                                                controller: _model
                                                    .fullNameTextController21,
                                                focusNode:
                                                    _model.fullNameFocusNode21,
                                                autofocus: true,
                                                textCapitalization:
                                                    TextCapitalization.words,
                                                obscureText: false,
                                                ...
                                                cursorColor: Color(0xFF6F61EF),
                                                validator: _model
                                                    .fullNameTextController21Validator
                                                    .asValidator(context),
                                                inputFormatters: [
                                                  _model.fullNameMask21
                                                ],
                                              ),
                                              Padding(
                                                padding: EdgeInsetsDirectional
                                              ...
                                              TextFormField(
                                                controller: _model
                                                    .fullNameTextController22,
                                                focusNode:
                                                    _model.fullNameFocusNode22,
                                                autofocus: true,
                                                textCapitalization:
                                                    TextCapitalization.words,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'i6nhuc92' /* Peso ideal para esse aluno */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                                ...
                                                cursorColor: Color(0xFF6F61EF),
                                                validator: _model
                                                    .fullNameTextController22Validator
                                                    .asValidator(context),
                                                inputFormatters: [
                                                  _model.fullNameMask22
                                                ],
                                              ),
                                              TextFormField(
                                                controller: _model
                                                    .fullNameTextController23,
                                                focusNode:
                                                    _model.fullNameFocusNode23,
                                                autofocus: true,
                                                textCapitalization:
                                                    TextCapitalization.words,
                                                obscureText: false,
                                                ...
                                                cursorColor: Color(0xFF6F61EF),
                                                validator: _model
                                                    .fullNameTextController23Validator
                                                    .asValidator(context),
                                                inputFormatters: [
                                                  _model.fullNameMask23
                                                ],
                                              ),
                                              TextFormField(
                                                controller: _model
                                                    .fullNameTextController24,
                                                focusNode:
                                                    _model.fullNameFocusNode24,
                                                autofocus: true,
                                                textCapitalization:
                                                    TextCapitalization.words,
                                                obscureText: false,
                                                ...
                                                cursorColor: Color(0xFF6F61EF),
                                                validator: _model
                                                    .fullNameTextController24Validator
                                                    .asValidator(context),
                                                inputFormatters: [
                                                  if (!isAndroid && !isiOS)
                                                    TextInputFormatter
                                              ...
                                              Row(
                                                ...
                                                children: [
                                                  ClipRRect(
                                                    ...
                                                    child: Image.network(
                                                      valueOrDefault<String>(
                                                        _model.isUploader
                                                            ? _model
                                                                .uploadedFileUrl_uploadData0nl7
                                                            : _model
                                                                .uploadedFileUrl_uploadData0nl7,
                                                  ...
                                                  FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'CREATE_AVALIACAO_FISICAYUHASZ6DOBRAS_CAR');
                                                      logFirebaseEvent(
                                                      ...
                                                      if (selectedMedia !=
                                                          ...
                                                          selectedMedia.every((m) =>
                                                              validateFileFormat(
                                                                  ...
                                                                  context))) {
                                                        safeSetState(() => _model
                                                                .isDataUploading_uploadData0nl7 =
                                                            true);
                                                        ...
                                                        try {
                                                          ...
                                                          _model.isDataUploading_uploadData0nl7 =
                                                              false;
                                                        }
                                                        if (selectedUploadedFiles
                                                            ...
                                                            downloadUrls
                                                                ...
                                                                selectedMedia
                                                                    .length) {
                                                          safeSetState(() {
                                                            _model.uploadedLocalFile_uploadData0nl7 =
                                                                selectedUploadedFiles
                                                                    .first;
                                                            _model.uploadedFileUrl_uploadData0nl7 =
                                                                downloadUrls
                                                                    .first;
                                                          });
                                                        } else {
                            ...
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'CREATE_AVALIACAO_FISICAYUHASZ6DOBRAS_SAL');
                                    ...
                                    await avaliacoesFisicasRecordReference
                                      ...
                                      abdominalAntropometria: double.tryParse(
                                          _model.fullNameTextController20.text),
                                      pesoIdeal: double.tryParse(
                                          _model.fullNameTextController22.text),
                                      proposta: double.tryParse(
                                          _model.fullNameTextController23.text),
                                      objetivoDoAluno:
                                          _model.fullNameTextController24.text,
                                      ...
                                      fotoDoAluno:
                                          _model.uploadedFileUrl_uploadData0nl7,
                                      protocoloDeAvaliacao: 'Yuhasz - 6 Dobras',
                                      ...
                                      supraIlaca: double.tryParse(
                                          _model.fullNameTextController18.text),
                                      peitoralAntropometria: double.tryParse(
                                          _model.fullNameTextController19.text),
                                      coxaAntropometria: double.tryParse(
                                          _model.fullNameTextController21.text),
                                      uid:
                                          createAvaliacaoFisicayuhasz6dobrasUsersRecord
                                              .uid,
                                      feita: false,
                                    ));
                                    _model.avalicaofisica = AvaliacoesFisicasRecord
                                        .getDocumentFromData(
                                            createAvaliacoesFisicasRecordData(
                                              ...
                                              subescapular: double.tryParse(
                                                  _model
                                                      .fullNameTextController17
                                                      .text),
                                              supraIlaca: double.tryParse(_model
                                                  .fullNameTextController18
                                                  .text),
                                              peitoralAntropometria:
                                                  double.tryParse(_model
                                                      .fullNameTextController19
                                                      .text),
                                              coxaAntropometria:
                                    ...
                                    triggerPushNotification(
                                      ...
                                      notificationText:
                                          'Seu personal adicionou uma nova avaliação, no protocolo ${_model.avalicaofisica?.protocoloDeAvaliacao} no dia ${dateTimeFormat(
                                        "d/M H:mm",
                                        getCurrentTimestamp,
                                      ...
                                      parameterData: {
                                        'avaliacaoFisica':
                                            _model.avalicaofisica?.reference,
                                        'users': widget!.users,
                                      },
                                    );
