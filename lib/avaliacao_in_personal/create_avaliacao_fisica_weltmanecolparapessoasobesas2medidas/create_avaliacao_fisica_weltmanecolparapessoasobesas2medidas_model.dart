...
import 'dart:ui';
import '/index.dart';
import 'create_avaliacao_fisica_weltmanecolparapessoasobesas2medidas_widget.dart'
    show CreateAvaliacaoFisicaWeltmanecolparapessoasobesas2medidasWidget;
...
class CreateAvaliacaoFisicaWeltmanecolparapessoasobesas2medidasModel
  ...
  String? _fullNameTextController2Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '32btgo9d' /* Please enter the patients full... */,
      );
    }
  ...
  String? _ageTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'g7bq6t7k' /* Please enter an age for the pa... */,
      );
    }
  ...
  bool isDataUploading_uploadData0nl453 = false;
  FFUploadedFile uploadedLocalFile_uploadData0nl453 =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadData0nl453 = '';
