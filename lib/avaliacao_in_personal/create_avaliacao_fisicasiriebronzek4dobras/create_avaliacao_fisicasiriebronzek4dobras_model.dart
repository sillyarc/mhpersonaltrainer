...
import 'dart:ui';
import '/index.dart';
import 'create_avaliacao_fisicasiriebronzek4dobras_widget.dart'
    show CreateAvaliacaoFisicasiriebronzek4dobrasWidget;
...
class CreateAvaliacaoFisicasiriebronzek4dobrasModel
    extends FlutterFlowModel<CreateAvaliacaoFisicasiriebronzek4dobrasWidget> {
  ...
  String? _fullNameTextController2Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '7qo8neq7' /* Please enter the patients full... */,
      );
    }
  ...
  String? _ageTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '2306u21l' /* Please enter an age for the pa... */,
      );
    }
  ...
  bool isDataUploading_uploadData0nly6 = false;
  FFUploadedFile uploadedLocalFile_uploadData0nly6 =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadData0nly6 = '';
