...
import 'dart:ui';
import '/index.dart';
import 'create_avaliacao_fisica_pollock1994setedobras_widget.dart'
    show CreateAvaliacaoFisicaPollock1994setedobrasWidget;
...
class CreateAvaliacaoFisicaPollock1994setedobrasModel
    extends FlutterFlowModel<CreateAvaliacaoFisicaPollock1994setedobrasWidget> {
  ...
  String? _fullNameTextController2Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'wc2yggfl' /* Please enter the patients full... */,
      );
    }
  ...
  String? _ageTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'y3uq03e7' /* Please enter an age for the pa... */,
      );
    }
  ...
  bool isDataUploading_uploadData0nly = false;
  FFUploadedFile uploadedLocalFile_uploadData0nly =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadData0nly = '';
