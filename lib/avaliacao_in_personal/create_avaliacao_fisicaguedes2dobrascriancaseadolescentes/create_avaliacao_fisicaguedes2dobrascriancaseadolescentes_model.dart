...
import 'dart:ui';
import '/index.dart';
import 'create_avaliacao_fisicaguedes2dobrascriancaseadolescentes_widget.dart'
    show CreateAvaliacaoFisicaguedes2dobrascriancaseadolescentesWidget;
...
class CreateAvaliacaoFisicaguedes2dobrascriancaseadolescentesModel
  ...
  String? _fullNameTextController2Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ewjdbx4i' /* Please enter the patients full... */,
      );
    }
  ...
  String? _ageTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'cd1k84go' /* Please enter an age for the pa... */,
      );
    }
  ...
  bool isDataUploading_uploadData0nl47h5 = false;
  FFUploadedFile uploadedLocalFile_uploadData0nl47h5 =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadData0nl47h5 = '';
