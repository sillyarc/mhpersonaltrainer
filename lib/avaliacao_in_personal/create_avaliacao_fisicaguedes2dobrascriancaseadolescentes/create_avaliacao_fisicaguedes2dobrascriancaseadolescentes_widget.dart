...
import 'create_avaliacao_fisicaguedes2dobrascriancaseadolescentes_model.dart';
export 'create_avaliacao_fisicaguedes2dobrascriancaseadolescentes_model.dart';

class CreateAvaliacaoFisicaguedes2dobrascriancaseadolescentesWidget
    extends StatefulWidget {
  const CreateAvaliacaoFisicaguedes2dobrascriancaseadolescentesWidget({
    super.key,
    required this.users,
  });
  ...
  @override
  State<CreateAvaliacaoFisicaguedes2dobrascriancaseadolescentesWidget>
      createState() =>
          _CreateAvaliacaoFisicaguedes2dobrascriancaseadolescentesWidgetState();
}

class _CreateAvaliacaoFisicaguedes2dobrascriancaseadolescentesWidgetState
    extends State<
        CreateAvaliacaoFisicaguedes2dobrascriancaseadolescentesWidget> {
  late CreateAvaliacaoFisicaguedes2dobrascriancaseadolescentesModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context,
        () => CreateAvaliacaoFisicaguedes2dobrascriancaseadolescentesModel());

    logFirebaseEvent('screen_view', parameters: {
      'screen_name': 'createAvaliacaoFisicaguedes2dobrascrianc'
    });
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final createAvaliacaoFisicaguedes2dobrascriancaseadolescentesUsersRecord =
            snapshot.data!;

        return Title(
            title: 'createAvaliacaoFisicaguedes2dobrascriancaseadolescentes',
                        ...
                        child: AppBar(
                          ...
                          title: StreamBuilder<List<AvaliacoesFisicasRecord>>(
                            stream: queryAvaliacoesFisicasRecord(
                              parent:
                                  createAvaliacaoFisicaguedes2dobrascriancaseadolescentesUsersRecord
                                      .reference,
                              singleRecord: true,
                            ),
                            builder: (context, snapshot) {
                              ...
                              return Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'nx54yyil' /* Avalie as métricas deste aluno... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                          ...
                          actions: [
                            Padding(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CREATE_AVALIACAO_FISICAGUEDES2DOBRASCRIA');
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'apko2luj' /* Guedes - 2 Dobras - Crianças e... */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'py75bqeh' /* Braço Esquerdo: Exemplo: 26.5 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'acw9qpmv' /* Braço Direito: Exemplo: 26.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    '3vcrpw5x' /* Abdominal: Exemplo: 80.5 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'wkp1crjx' /* Quadril: Exemplo: 100.5 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'xj9szm63' /* Coxa Esquerda: Exemplo: 50.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'cfrtfgk4' /* Coxa Direita: Exemplo: 70.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'jlwsh0ci' /* Perna Esquerda: Exemplo: 30.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'wpnkbhv7' /* Perna Direita: Exemplo: 30.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'o6cdqxts' /* Tricipital: Exemplo: 19.5 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    '0rdwojro' /* Subescapular: Exemplo: 17.5 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    '84cbpeq6' /* Peso ideal para esse aluno */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                                  ...
                                                  ClipRRect(
                                                    ...
                                                    child: Image.network(
                                                      valueOrDefault<String>(
                                                        _model.isUploader
                                                            ? _model
                                                                .uploadedFileUrl_uploadData0nl47h5
                                                            : _model
                                                                .uploadedFileUrl_uploadData0nl47h5,
                                                      ...
                                                      if (selectedMedia !=
                                                          ...
                                                          selectedMedia.every((m) =>
                                                              validateFileFormat(
                                                                  ...
                                                                  context))) {
                                                        safeSetState(() => _model
                                                                .isDataUploading_uploadData0nl47h5 =
                                                            true);
                                                        ...
                                                        try {
                                                          ...
                                                          _model.isDataUploading_uploadData0nl47h5 =
                                                              false;
                                                        }
                                                        if (selectedUploadedFiles
                                                            ...
                                                            downloadUrls
                                                                ...
                                                                selectedMedia
                                                                    .length) {
                                                          safeSetState(() {
                                                            _model.uploadedLocalFile_uploadData0nl47h5 =
                                                                selectedUploadedFiles
                                                                    .first;
                                                            _model.uploadedFileUrl_uploadData0nl47h5 =
                                                                downloadUrls
                                                                    .first;
                                                          });
                                                        } else {
