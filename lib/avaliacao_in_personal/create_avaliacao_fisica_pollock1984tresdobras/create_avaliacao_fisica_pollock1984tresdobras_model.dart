...
import 'dart:ui';
import '/index.dart';
import 'create_avaliacao_fisica_pollock1984tresdobras_widget.dart'
...
class CreateAvaliacaoFisicaPollock1984tresdobrasModel
    extends FlutterFlowModel<CreateAvaliacaoFisicaPollock1984tresdobrasWidget> {
  ...
  String? _fullNameTextController2Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '4agqfip2' /* Please enter the patients full... */,
      );
    }
  ...
  String? _ageTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'rxusrts8' /* Please enter an age for the pa... */,
      );
    }
  ...
  bool isDataUploading_uploadData0nly34 = false;
  FFUploadedFile uploadedLocalFile_uploadData0nly34 =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadData0nly34 = '';
