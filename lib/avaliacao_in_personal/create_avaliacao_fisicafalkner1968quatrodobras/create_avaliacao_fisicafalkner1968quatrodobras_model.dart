...
import '/index.dart';
import 'create_avaliacao_fisicafalkner1968quatrodobras_widget.dart'
...
class CreateAvaliacaoFisicafalkner1968quatrodobrasModel
  ...
  String? _fullNameTextController2Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'go6bo8p0' /* Please enter the patients full... */,
      );
    }
  ...
  String? _ageTextController1Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'tvv6u0l7' /* Please enter an age for the pa... */,
      );
    }
  ...
  bool isDataUploading_uploadData0nl476 = false;
  FFUploadedFile uploadedLocalFile_uploadData0nl476 =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadData0nl476 = '';
  ...
  String? _fullNameTextController24Validator(
      BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'sy8q9tsd' /* Please enter the patients full... */,
      );
    }
  ...
  late MaskTextInputFormatter fullNameMask42;
  String? Function(BuildContext, String?)? fullNameTextController42Validator;
  // State field(s) for fullName widget.
  FocusNode? fullNameFocusNode43;
  TextEditingController? fullNameTextController43;
  late MaskTextInputFormatter fullNameMask43;
  String? Function(BuildContext, String?)? fullNameTextController43Validator;
  // State field(s) for fullName widget.
  FocusNode? fullNameFocusNode44;
  TextEditingController? fullNameTextController44;
  String? Function(BuildContext, String?)? fullNameTextController44Validator;
  // Model for datePickerFormulas component.
  ...
  String? _ageTextController2Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'bleb1pu9' /* Please enter an age for the pa... */,
      );
    }
  ...
  bool isDataUploading_uploadData0nl47 = false;
  FFUploadedFile uploadedLocalFile_uploadData0nl47 =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadData0nl47 = '';
  ...
  void dispose() {
    ...
    fullNameFocusNode43?.dispose();
    fullNameTextController43?.dispose();

    fullNameFocusNode44?.dispose();
    fullNameTextController44?.dispose();
