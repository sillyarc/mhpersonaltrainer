...
import 'dart:ui';
import '/index.dart';
import 'create_avaliacao_fisicapenroenelsonefisher1985ecoteewilmore2medidas_widget.dart'
    show
...
class CreateAvaliacaoFisicapenroenelsonefisher1985ecoteewilmore2medidasModel
  ...
  String? _dateOfBirthTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'roppks9h' /* Please enter the date of birth... */,
      );
    }
  ...
  String? _fullNameTextController2Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'zjjabmda' /* Please enter the patients full... */,
      );
    }
  ...
  String? _ageTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '6dr6cta3' /* Please enter an age for the pa... */,
      );
    }
  ...
  bool isDataUploading_uploadData0nl46 = false;
  FFUploadedFile uploadedLocalFile_uploadData0nl46 =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadData0nl46 = '';
