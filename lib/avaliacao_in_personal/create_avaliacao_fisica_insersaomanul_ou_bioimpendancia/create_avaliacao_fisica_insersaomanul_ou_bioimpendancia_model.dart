...
import 'dart:ui';
import '/index.dart';
import 'create_avaliacao_fisica_insersaomanul_ou_bioimpendancia_widget.dart'
    show CreateAvaliacaoFisicaInsersaomanulOuBioimpendanciaWidget;
...
class CreateAvaliacaoFisicaInsersaomanulOuBioimpendanciaModel
  ...
  String? _dateOfBirthTextControllerValidator(
    ...
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        '0z8kw5c8' /* Please enter the date of birth... */,
      );
    }
  ...
  String? _fullNameTextController2Validator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'ha79qmod' /* Please enter the patients full... */,
      );
    }
  ...
  String? _ageTextControllerValidator(BuildContext context, String? val) {
    if (val == null || val.isEmpty) {
      return FFLocalizations.of(context).getText(
        'msnmtr1v' /* Please enter an age for the pa... */,
      );
    }
  ...
  bool isDataUploading_uploadData0nl4645 = false;
  FFUploadedFile uploadedLocalFile_uploadData0nl4645 =
      FFUploadedFile(bytes: Uint8List.fromList([]));
  String uploadedFileUrl_uploadData0nl4645 = '';
