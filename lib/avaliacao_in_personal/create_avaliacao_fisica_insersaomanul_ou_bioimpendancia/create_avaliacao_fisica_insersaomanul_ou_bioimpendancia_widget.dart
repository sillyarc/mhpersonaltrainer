...
import 'create_avaliacao_fisica_insersaomanul_ou_bioimpendancia_model.dart';
export 'create_avaliacao_fisica_insersaomanul_ou_bioimpendancia_model.dart';

class CreateAvaliacaoFisicaInsersaomanulOuBioimpendanciaWidget
    extends StatefulWidget {
  const CreateAvaliacaoFisicaInsersaomanulOuBioimpendanciaWidget({
    super.key,
    required this.users,
  });
  ...
  @override
  State<CreateAvaliacaoFisicaInsersaomanulOuBioimpendanciaWidget>
      createState() =>
          _CreateAvaliacaoFisicaInsersaomanulOuBioimpendanciaWidgetState();
}

class _CreateAvaliacaoFisicaInsersaomanulOuBioimpendanciaWidgetState
    extends State<CreateAvaliacaoFisicaInsersaomanulOuBioimpendanciaWidget> {
  late CreateAvaliacaoFisicaInsersaomanulOuBioimpendanciaModel _model;
  ...
  void initState() {
    ...
    _model = createModel(context,
        () => CreateAvaliacaoFisicaInsersaomanulOuBioimpendanciaModel());

    logFirebaseEvent('screen_view', parameters: {
      'screen_name': 'createAvaliacaoFisicaInsersaomanulOuBioi'
    });
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final createAvaliacaoFisicaInsersaomanulOuBioimpendanciaUsersRecord =
            snapshot.data!;

        return Title(
            title: 'createAvaliacaoFisicaInsersaomanulOuBioimpendancia',
                        ...
                        child: AppBar(
                          ...
                          title: StreamBuilder<List<AvaliacoesFisicasRecord>>(
                            stream: queryAvaliacoesFisicasRecord(
                              parent:
                                  createAvaliacaoFisicaInsersaomanulOuBioimpendanciaUsersRecord
                                      .reference,
                              singleRecord: true,
                            ),
                            builder: (context, snapshot) {
                              ...
                              return Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    FFLocalizations.of(context).getText(
                                      'b41x7fkf' /* Avalie as métricas deste aluno... */,
                                    ),
                                    style: FlutterFlowTheme.of(context)
                                        .labelMedium
                                        .override(
                          ...
                          actions: [
                            Padding(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  logFirebaseEvent(
                                      'CREATE_AVALIACAO_FISICA_INSERSAOMANUL_OU');
                                            ...
                                            children: [
                                                  ...
                                                  child: Padding(
                                                    ...
                                                    child: Text(
                                                      FFLocalizations.of(
                                                              context)
                                                          .getText(
                                                        'nqgtqb44' /* Inserção Manual ou Bioimpendân... */,
                                                      ),
                                                      style:
                                                          FlutterFlowTheme.of(
                                                                  context)
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'd3jte38z' /* Braço Esquerdo: Exemplo: 26.5 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'g6cynfyn' /* Braço Direito: Exemplo: 26.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'bokntq7k' /* Abdominal: Exemplo: 80.5 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'rh3smru9' /* Quadril: Exemplo: 100.5 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'f2xcybys' /* Coxa Esquerda: Exemplo: 50.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'xflf1snc' /* Coxa Direita: Exemplo: 70.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'pinc03bw' /* Perna Esquerda: Exemplo: 30.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    '3xubmxhl' /* Perna Direita: Exemplo: 30.0 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'kivsrpuj' /* Percentual de Gordura */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                              ...
                                              Padding(
                                                ...
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'uchdhhts' /* Obtido através de bioimpendânc... */,
                                                  ),
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    '9tbr1pic' /* % de Gordura: Exemplo: 19.5 */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                              ...
                                              TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'z4ftebly' /* Peso ideal para esse aluno */,
                                                  ),
                                                  labelStyle: FlutterFlowTheme
                                                          .of(context)
                                                      .headlineMedium
                                                  ...
                                                  ClipRRect(
                                                    ...
                                                    child: Image.network(
                                                      valueOrDefault<String>(
                                                        _model.isUploader
                                                            ? _model
                                                                .uploadedFileUrl_uploadData0nl4645
                                                            : _model
                                                                .uploadedFileUrl_uploadData0nl4645,
                                                      ...
                                                      if (selectedMedia !=
                                                          ...
                                                          selectedMedia.every((m) =>
                                                              validateFileFormat(
                                                                  ...
                                                                  context))) {
                                                        safeSetState(() => _model
                                                                .isDataUploading_uploadData0nl4645 =
                                                            true);
                                                        ...
                                                        try {
                                                          ...
                                                          _model.isDataUploading_uploadData0nl4645 =
                                                              false;
                                                        }
                                                        if (selectedUploadedFiles
                                                            ...
                                                            downloadUrls
                                                                ...
                                                                selectedMedia
                                                                    .length) {
                                                          safeSetState(() {
                                                            _model.uploadedLocalFile_uploadData0nl4645 =
                                                                selectedUploadedFiles
                                                                    .first;
                                                            _model.uploadedFileUrl_uploadData0nl4645 =
                                                                downloadUrls
                                                                    .first;
                                                          });
                                                        } else {
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    await avaliacoesFisicasRecordReference
                                      ...
                                      porcentualDeGordura: double.tryParse(
                                          _model.fullNameTextController16.text),
                                      uid:
                                          createAvaliacaoFisicaInsersaomanulOuBioimpendanciaUsersRecord
                                              .uid,
