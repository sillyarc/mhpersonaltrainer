...
/// Create a update value personal service component
class ServiceEditWidget extends StatefulWidget {
  const ServiceEditWidget({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'alwyb60b' /* Crie seu serviço em nossa plat... */,
                          ),
                          style:
                  ...
                  FlutterFlowIconButton(
                    ...
                    onPressed: () async {
                      logFirebaseEvent('SERVICE_EDIT_COMP_close_ICN_ON_TAP');
              ...
              FFButtonWidget(
                onPressed: () async {
                  logFirebaseEvent('SERVICE_EDIT_CRIAR_SERVIO_BTN_ON_TAP');
                  logFirebaseEvent('Button_backend_call');

                  await currentUserReference!.update({
                    ...mapToFirestore(
                      {
                        'servicos': FieldValue.arrayUnion([
                          getMHVitrineFirestoreData(
                            updateMHVitrineStruct(
                              MHVitrineStruct(
