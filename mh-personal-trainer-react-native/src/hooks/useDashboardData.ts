...
import { firestoreService, Treino, Aluno, Avaliacao, DashboardStats } from '../services/firestoreService';
import { fetchUserWorkouts } from '../services/workouts';
...
export function useDashboardData(): DashboardData {
  ...
  useEffect(() => {
    if (!user?.uid || isAdmin || !isPersonal) {
