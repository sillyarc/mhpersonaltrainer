...
export default function AcademyStudentsPage() {
  ...
  const handleLinkByEmail = async () => {
    ...
    if (!academyCodeRaw) {
      setLinkByEmailMessage('Codigo da academia nao encontrado.');
      return;
    }
  ...
  const handleCreateStudent = async () => {
    ...
    if (!academyCodeRaw) {
      setCreateMessage('Codigo da academia nao encontrado.');
      return;
    }
        ...
        <div className="academy-dashboard academy-revamp academy-students-page academy-enroll">
          <section className="academy-enroll-hero">
            ...
            <aside className="academy-enroll-hero-side">
              <div className="academy-enroll-code">
                <span>Codigo da academia</span>
                <strong>{academyCode || '--'}</strong>
                <p>Use este codigo para manter os alunos vinculados ao painel da academia.</p>
              </div>
          ...
          <section className="academy-enroll-workflow">
            ...
            <article id="link-student" className="academy-enroll-panel">
              <header className="academy-enroll-panel-head">
                ...
                <p className="subtle">Busca por email e conecta ao codigo da academia.</p>
              </header>
              <div className="academy-enroll-form">
                <label>
