...
const ULTRA_BLUE_PANEL_STYLE: CSSProperties = {
  ['--cmd-ink' as string]: '#e8efff',
  ['--cmd-muted' as string]: '#a8bfdf',
  ['--cmd-accent' as string]: '#7aa8ff',
  ['--cmd-border' as string]: 'rgba(90, 121, 174, 0.5)',
  ['--cmd-card' as string]: '#0b1d35',
  ['--cmd-soft' as string]: '#1b3a61',
  ['--cmd-soft-strong' as string]: '#234a76',
  background: 'linear-gradient(165deg, #01060f 0%, #041227 40%, #082043 100%)',
  border: 'none',
  borderRadius: 18,
  padding: 16,
};

const ULTRA_BLUE_CONTROL_STYLE: CSSProperties = {
  background: '#173553',
  border: '0.75px solid rgba(110, 148, 205, 0.42)',
  color: '#e8efff',
};

const ULTRA_BLUE_INPUT_STYLE: CSSProperties = {
  background: '#1b3a61',
  border: '1px solid rgba(110, 148, 205, 0.52)',
  color: '#e8efff',
};
...
export default function AcademyDashboardPage() {
  ...
  const handleRegisterCheckin = async () => {
    ...
    try {
      ...
      const academyReference = academyCodeRaw || user?.uid || 'academy';
      ...
      if (checkinMethod === 'foto') {
        ...
        const fileName = `checkin-${academyReference}-${checkinStudentId}-${Date.now()}.jpg`;
        ...
        if (!expectedToken) {
          const methodLabel = checkinMethod === 'biometria' ? 'biometria' : 'NFC';
          setCheckinMessage(
            `Aluno sem ${methodLabel} cadastrado. Configure em Credenciais antes do check-in.`
          );
          return;
        }
      ...
      await addDoc(collection(db, 'academyCheckins'), {
        ...
        academyCode: academyCodeRaw || user?.uid || null,
      ...
      const updates: Record<string, any> = {
        ...
        last_checkin_academy: academyCodeRaw || user?.uid || '',
      };
  ...
  return (
    <div className="academy-ultra-blue-page">
      <PageShell
      ...
      >
        ...
        {checkinOpen && (
          <div className="academy-checkin-overlay academy-ultra-blue-modal" onClick={closeCheckin}>
              ...
              <div className="academy-checkin-body">
                <div className="academy-checkin-methods">
                  <button
                    ...
                    style={ULTRA_BLUE_CONTROL_STYLE}
                    title={
                  ...
                  {(() => {
                    ...
                    if (checkinMethod === 'biometria') {
                      ...
                      return selectedCheckinStudent.biometricId
                        ...
                        : 'Aluno sem biometria cadastrada. Cadastre em Credenciais antes do check-in.';
                    }
                    ...
                    return selectedCheckinStudent.nfcTagId
                      ...
                      : 'Aluno sem NFC cadastrado. Cadastre em Credenciais antes do check-in.';
                  })()}
                </div>
        ...
        <div
          className="academy-dashboard academy-revamp academy-hub academy-ops academy-ultra-blue"
          style={ULTRA_BLUE_PANEL_STYLE}
        >
          ...
          <section className="academy-ops-grid academy-ops-grid-primary academy-ops-grid-split">
            <div className="academy-ops-grid-stack">
              ...
              <div className="academy-ops-actions">
                ...
                <button type="button" className="button secondary sm" onClick={() => openCheckin('biometria')}>
                  Configurar acesso e identificacao
                </button>
